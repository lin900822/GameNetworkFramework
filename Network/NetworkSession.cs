...
public class NetworkSession
{
    ...
    public Action<NetworkSession> OnReceivedNothing;
    ...
    public NetworkSession(ByteBufferPool pool, int bufferSize)
    {
    ...
    public void SetActive(Socket socket)
    {
        Socket = socket;
